            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('welcome.index') }}" class="flex items-center">
                        <img src="image/logo.jpg" class="h-8 w-8 mr-2" alt="Icon"> <!-- Tambahkan gambar ikon disini -->
                        <span><i><b>LAUNDRY SMKN 1 CIAMIS</b></i></span>
                    </a>
                </div>
            </div>
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="flex items-center">
                    <!-- Logo -->
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('order.index') }}" class="flex items-center">
                            <img src="image/logo.jpg" class="h-8 w-8 mr-2" alt="Icon"> <!-- Tambahkan gambar ikon disini -->
                            <span><i><b>LAUNDRY SMKN 1 CIAMIS</b></i></span>
                        </a>
                    </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user()->role == 'admin' || Auth::user()->role == 'petugas' || Auth::user()->role == 'pimpinan')
